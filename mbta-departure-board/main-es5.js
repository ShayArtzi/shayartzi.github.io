(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppComponentsMainPageMainPageComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<div class=\"col\">\n\n  <div class=\"d-flex align-items-center justify-content-between\">\n    <h3>North station - Departures</h3>\n    <button class=\"btn btn-secondary btn-sm\" (click)=\"fetchData()\" title=\"Refresh data\">&#x21ba;</button>\n  </div>\n\n  <div class=\"d-flex justify-content-end\">\n    <div class=\"small\" *ngIf=\"lastUpdateTime\">\n      <span>Last update time: </span>\n      <span>{{lastUpdateTime | date: 'mediumTime'}}</span>\n    </div>\n  </div>\n\n\n  <div *ngIf=\"preds && !error\">\n    <table class=\"table table-dark\">\n      <thead>\n      <tr>\n        <th scope=\"col\">Time</th>\n        <th scope=\"col\">Dest.</th>\n        <th scope=\"col\">Train #</th>\n        <th scope=\"col\">Track</th>\n        <th scope=\"col\">Status</th>\n      </tr>\n      </thead>\n      <tbody>\n      <tr *ngFor=\"let pred of preds\">\n        <td colspan=\"5\" *ngIf=\"!pred.trip; else row\">Loading</td>\n        <ng-template #row>\n          <td>{{pred.attributes.departure_time | date : 'shortTime'}}</td>\n          <td>{{pred.trip.attributes.headsign}}</td>\n          <td>{{pred.trip.attributes.name}}</td>\n          <td>{{extractTrackId(pred.relationships.stop.data.id)}}</td>\n          <td>{{pred.attributes.status}}</td>\n        </ng-template>\n\n      </tr>\n      </tbody>\n    </table>\n  </div>\n\n  <div *ngIf=\"error\">\n    <h3>Error fetching data from MBTA API</h3>\n  </div>\n\n</div>\n\n\n\n\n";
    /***/
  },
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let AppComponent = class AppComponent {
      constructor() {
        this.title = 'mbta-departure-board';
      }
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_3__["AppComponent"], _components_main_page_main_page_component__WEBPACK_IMPORTED_MODULE_4__["MainPageComponent"]],
  ...
  function srcAppComponentsMainPageMainPageComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2NvbXBvbmVudHMvbWFpbi1wYWdlL21haW4tcGFnZS5jb21wb25lbnQuc2NzcyJ9 */";
    /***/
  },
  ...
  function srcAppComponentsMainPageMainPageComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _services_mbta_api_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../../services/mbta-api.service */
    "./src/app/services/mbta-api.service.ts");

    let MainPageComponent = class MainPageComponent {
      constructor(mbtaApiService) {
        this.mbtaApiService = mbtaApiService;
        this.error = false;
      }
    ...
    MainPageComponent.ctorParameters = () => [{
      type: _services_mbta_api_service__WEBPACK_IMPORTED_MODULE_2__["MbtaApiService"]
    }];
  ...
  /*! exports provided: MbtaApiService */

  /***/
  function srcAppServicesMbtaApiServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "MbtaApiService", function () {
      return MbtaApiService;
    });
    /* harmony import */
    ...
    let MbtaApiService = class MbtaApiService {
      constructor(http) {
        this.http = http;
        this.urlPrefix = 'https://api-v3.mbta.com';
      }
      ...
      get(url) {
        ...
        return this.http.get("".concat(this.urlPrefix, "/").concat(url), {
          headers
        });
      }
      ...
      getTrip(tripId) {
        ...
        return this.get("trips/".concat(tripId));
      }

    };

    MbtaApiService.ctorParameters = () => [{
      type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]
    }];

    MbtaApiService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    })], MbtaApiService);
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\dev\mbta-departure-board\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
